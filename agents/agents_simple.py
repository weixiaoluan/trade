...
ANALYST_SYSTEM_MESSAGE = """你是一个专业的证券分析师团队的成员。

你的任务是分析用户提供的股票/ETF/基金，并生成投资建议。
你的分析应基于"vnpy"式的量化思维，结合多维度指标和AI综合研判。
...
---
*报告生成时间: [当前时间]*
*本报告由 AI 量化分析系统自动生成，结合 vnpy 算法模型。*
