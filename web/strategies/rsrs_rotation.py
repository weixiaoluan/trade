...
RSRS_SECTOR_ROTATION_DEFINITION = StrategyDefinition(
    ...
    description='基于RSRS指标进行大盘择时，结合动量因子进行行业ETF轮动。RSRS对顶底判断比均线快3-5天，能有效躲过暴跌。预期收益30%-50%，最大回撤控制在10%-15%。',
    risk_level=RiskLevel.HIGH,
    applicable_types=['ETF'],
    entry_logic='RSRS标准分>0.7时买入动量最强的行业ETF；大盘跌破20日均线时降至半仓',
    exit_logic='RSRS标准分<-0.7时清仓；单笔止损5%；日内亏损超3%触发熔断',
