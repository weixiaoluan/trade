              ...
              <table className="w-full">
                <thead className="bg-white/[0.02]">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-right text-xs font-medium text-emerald-400">支撑位</th>
                    <th className="px-4 py-3 text-right text-xs font-medium text-rose-400">阻力位</th>
                  </tr>
                </thead>
